    ...
    return (
        <div className="flex items-center justify-between py-3 px-10 bg-white bg-opacity-75">
            ...
            <div className="flex items-center gap-8">
                <button onClick={handleLogout} className="bg-violet-600 hover:bg-violet-700 transition delay-100 font-semibold text-sm text-violet-100 px-7 py-1 rounded-lg ">
                    Logout
                </button>
